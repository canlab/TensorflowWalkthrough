#!/usr/bin/env python3
# That ^ is a shebang. That line needs to be at the top of every executable Python script.

from __future__ import absolute_import, division, print_function

# Tell Python we're going to be using TensorFlow and tf.keras
import tensorflow as tf
from tensorflow import keras

# Tell Python about some of our other helper libraries
import numpy as np
import matplotlib.pyplot as plot

# Some functions to help us plot our results
